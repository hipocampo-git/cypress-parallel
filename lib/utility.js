...
function generateSummaryResultsFile(text) {
  try{
    fs.writeFileSync('results-summary.json', text, 'utf8');
    console.log('Summary Results generated');
  } catch(e) {
    console.error(e)
  }
}
